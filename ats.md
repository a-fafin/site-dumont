...
layout: default
title: "Filière ATS"
description: "Présentation de la filière ATS — Adaptation Technicien Supérieur — Lycée Dumont d'Urville-Laplace, Caen."
hero_badge: "Passerelle"
hero_title: "Filière <span>ATS</span>"
hero_subtitle: "Adaptation Technicien Supérieur - 1 an"
---
...
L'année ATS est très intensive et couvre les matières fondamentales des concours :

- **Mathématiques** : remise à niveau et approfondissement
- **Physique** : mécanique, électromagnétisme, thermodynamique
- **Sciences de l'ingénieur** : automatique, mécanique des systèmes
- **Anglais**
- Nombreuses **colles** et entraînements aux épreuves

## Concours accessibles

- **Arts et Métiers (ENSAM)** — concours ATS
- **CCINP** (banque ATS)
- **e3a-Polytech**
- **INSA** (voie ATS)
- Et de nombreuses écoles sur dossier ou concours propres
...
<div style="margin-top:2rem;display:flex;gap:1rem;flex-wrap:wrap" markdown="0">
  <a href="/assets/pdf/flyer_prepa_ats.pdf" class="btn-primary" target="_blank">📄 Télécharger la plaquette ATS</a>
